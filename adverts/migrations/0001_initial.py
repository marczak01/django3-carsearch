# Generated by Django 3.2.5 on 2022-01-02 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adverts.advert')),
            ],
        ),
        migrations.AddField(
            model_name='advert',
            name='tags',
            field=models.ManyToManyField(blank=True, to='adverts.Tag'),
        ),
    ]
